...
export const HeroSection = () => {
  return (
    <section id="home" className="relative pt-28 md:pt-36 pb-20 md:pb-28 overflow-hidden noise">
      {/* Backdrop layers */}
      ...
      <div aria-hidden className="hidden md:flex absolute right-4 top-32 flex-col items-center gap-3 font-mincho text-[28px] text-tan/15 select-none leading-none">
        <span>東</span><span>京</span><span>夜</span>
      </div>
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-10 items-center">
          ...
          <div className="lg:col-span-7 order-2 lg:order-1">
            ...
            >
              ...
              <span className="text-foreground/90">Available · freelance & system work</span>
            ...
            >
              ...
              <span className="relative inline-block">
                ...
                <svg className="absolute -bottom-2 left-0 w-full" viewBox="0 0 200 12" fill="none" aria-hidden>
                  <path d="M2 9 C 60 2, 140 2, 198 9" stroke="hsl(var(--tan))" strokeWidth="2.5" strokeLinecap="round" />
                </svg>
              </span>
              ,{" "}
            ...
            >
              Hi, I'm <span className="font-semibold text-foreground">John Rey</span> — a full-stack developer who turns messy business workflows into clean, maintainable products. From HR &amp; payroll engines to multi-tenant SaaS, dashboards, and editorial landing pages — I focus on systems people actually use every day.
            </motion.p>
            ...
            >
              <span className="flex items-center gap-2"><Sparkles className="h-3.5 w-3.5 text-tan" /> 4+ yrs shipping</span>
          ...
          <div className="lg:col-span-5 order-1 lg:order-2 relative">
            ...
            >
              ...
              {/* Sparkles */}
              <Sparkle className="absolute top-2 right-12 z-20 animate-sparkle" size={18} />
              <Sparkle className="absolute bottom-10 left-3 z-20 animate-sparkle [animation-delay:-1.5s]" size={12} />
              <Sparkle className="absolute top-1/2 -right-2 z-20 animate-sparkle [animation-delay:-0.8s]" size={14} />
              ...
              >
                <span className="font-display text-sm">こんにちは <span className="text-tan">✦</span></span>
              </motion.div>
              ...
              {floatChips.map((c) => (
                ...
                >
                  ...
                  >
                    <span className="text-tan mr-1">●</span>{c.label}
                  </motion.div>
                </motion.div>
              ))}
            </motion.div>
